package com.robintime.ocat.commons.web;

import com.robintime.ocat.commons.dto.AbstractBaseDomain;
import com.robintime.ocat.commons.dto.AbstractBaseResult;
import com.robintime.ocat.commons.dto.BaseResultFactory;
...
public abstract class AbstractBaseController<T extends AbstractBaseDomain> {
    ...
    // 用于动态获取配置文件的属性值
    private static final String ENVIRONMENT_LOGGING_LEVEL_MY_SHOP = "logging.level.com.robintime.ocat";
